          ...
          >
            ...
            <div className="flex flex-col flex-1 p-4 sm:p-5 lg:p-6">
              <div className="flex justify-between items-center mb-3">
                <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900">{formule.label}</h3>
                <span className="text-[#0049ac] font-bold text-sm sm:text-base lg:text-lg">
                  {formule.price}€
                </span>
              </div>

              <p className="text-xs sm:text-sm lg:text-base text-gray-600 mb-2 leading-relaxed">{formule.desc}</p>
              <p className="text-xs sm:text-sm text-gray-400">Durée : {formule.time} min</p>

              {formule.id === "4 places" && (
                <div className="mt-3">
                  <span className="inline-block px-3 sm:px-4 py-1 sm:py-2 rounded-full bg-yellow-400 text-white text-xs sm:text-sm font-semibold shadow">
                    Populaire
                  </span>
                </div>
              )}
