...
const ContactStep: React.FC<ContactStepProps> = ({ selections, totalPrice, totalTime, onReset, aspiration, canSubmit = true, onValidationError }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validation des champs obligatoires (aspiration et type de véhicule)
    if (onValidationError && !onValidationError()) {
      return; // La fonction onValidationError gère déjà l'affichage des erreurs et le scroll
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Remplissez vos informations pour finaliser votre demande de lavage automobile
          </p>
        </div>
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        Complétez les étapes obligatoires
                      </>
                    ) : (
                      <>
