...
interface TextileVerticalProgressBarProps {
  selections: Selection[];
  totalSteps: number;
}

const TextileVerticalProgressBar: React.FC<TextileVerticalProgressBarProps> = ({ selections, totalSteps }) => {
...
export default TextileVerticalProgressBar; 