...
interface TextileOptionsStepProps {
...
const TextileOptionsStep: React.FC<TextileOptionsStepProps> = ({ onSelect, nextSectionId, selected = [] }) => {
...
export default TextileOptionsStep; 